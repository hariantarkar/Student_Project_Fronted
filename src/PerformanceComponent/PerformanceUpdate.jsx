        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <input type="number" name="attendance_percentage"
              ...
              className="form-control" min="0" max="10"/>
            <span id="attendance_percentage_err"></span>
          </div>

          <div className="mb-3">
            <label className="form-label">Machine Test (0-10)</label>
            <input type="number" name="machine_test"
              value={formData.machine_test} onChange={handleChange}
              className="form-control" min="0" max="10"/>
          ...
          <div className="mb-3">
            ...
            <input type="number" name="mcq_test"
              value={formData.mcq_test} onChange={handleChange}
              className="form-control" min="0" max="10"/>
          ...
          <div className="mb-3">
            ...
            <input type="number" name="mock_interview_score"
              value={formData.mock_interview_score} onChange={handleChange}
              className="form-control" min="0" max="10"/>
            <span id="mock_interview_score_err"></span>
          </div>

          <button type="submit" className="btn btn-warning w-100 mb-3"
            disabled={loading}> {loading ? "Updating..." : "Update Performance"}
          </button>
