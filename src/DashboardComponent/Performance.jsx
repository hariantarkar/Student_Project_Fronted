...
//       try {
//         const data = await getStudentPerformance(); // ✅ use your service

//         if (!data || data.length === 0) {
//           setError("No performance data found");
//         } else {
//           setPerformances(data);
//           setSelected(data[0]); // default first attempt
//         }
//       } catch (err) {
...
export default function Performance() {
  ...
  // Convert to percentage (keep numeric)
  ...
  return (
    <div className="container mt-4">
      ...
      {/* Chart + Score Summary side by side */}
      <div className="row">
        {/* Pie chart */}
